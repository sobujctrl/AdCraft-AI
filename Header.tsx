...
import { Sparkles, Bookmark, Zap, Globe, Palette, Key } from 'lucide-react';
        ...
        <div className="flex items-center gap-2.5 w-full sm:w-auto justify-end flex-wrap">
          ...
          <div className="flex items-center bg-slate-800/90 border border-slate-700/80 rounded-lg p-1 text-xs">
            ...
            >
              ...
              <option value="royal" className="bg-slate-900 text-white">👑 Royal Purple (পার্পল)</option>
          ...
          <button
            ...
            title={hasCustomApiKey ? 'কাস্টম API Key সক্রিয় আছে' : 'API Key সেটিং সেটআপ করুন'}
          >
            <Key className="w-3.5 h-3.5" />
            <span>API Key</span>
            <span
              className={`w-2 h-2 rounded-full ${
                hasCustomApiKey ? 'bg-emerald-400 animate-pulse' : 'bg-amber-400'
              }`}
            />
          </button>
